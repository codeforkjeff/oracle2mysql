...
legacy_db_name = os.environ.get("SDBMSS_LEGACY_DB_NAME")
legacy_db_user = os.environ.get("SDBMSS_LEGACY_DB_USER")
legacy_db_password = os.environ.get("SDBMSS_LEGACY_DB_PASSWORD")
legacy_db_host = os.environ.get("SDBMSS_LEGACY_DB_HOST")
